...
2. **Zdrojový prompt:** `review-packages/PRODUCT_VERSION_PLACEHOLDER/source-prompt.md`
3. **Review rubric (A-K):** `review-packages/PRODUCT_VERSION_PLACEHOLDER/rubric.md`
4. **Changelog:** `review-packages/PRODUCT_VERSION_PLACEHOLDER/changelog-from-previous.md`

URL pattern: `https://raw.githubusercontent.com/lucierobinson/peppi-basics/main/review-packages/PRODUCT_VERSION_PLACEHOLDER/<file>`
